...
import icon from '../assets/icons/banners.svg'
import Platforms from './Platforms';

function Banners({ data, parent }) {
  ...
  return (
    <div className='section'>
      <span className="section_name section_2" onClick={() => setOpen(!open)}>
      ...
      <div className={open ? "section_body show_body" : "section_body"}>
        <Platforms data={data.sub[0]} parent={open} />
      </div>
    </div>
  )
}
